...
เก็บ `document_id`, SHA-256, page, extraction_method, OCR flag, text, block_id, source, confidence และ bounding box เพื่อให้ Phase Assessment ย้อนกลับไปหา Evidence ได้
